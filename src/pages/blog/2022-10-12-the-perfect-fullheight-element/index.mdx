...
As mentionned before, you may want to throttle the resize handler event.

I hope you found this useful, if you have any comments you can reach me on twitter [@heyralrom](https://twitter.com/heyralrom)
